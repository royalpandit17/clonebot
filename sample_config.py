...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("6849518475:AAEiei7sIkhbdE60FTVYBGN34Bc2AgW76fg"")
    ...
    # Database URI
    DB_URI = os.environ.get("mongodb+srv://clonebotshrey:QzenDwToCdtKJotp@shrey1.ulhp4pe.mongodb.net/?retryWrites=true&w=majority"")
